...
def leer_ejemplar(ruta: str):
    grafo = []

    if '~' in ruta:
        ruta_2 = os.path.expanduser(ruta)
    else:
        ruta_2 = ruta
    with open(str(ruta_2)) as archivo:
    ...
    return nodos, aristas, arista_mayor, arista_menor
...
if __name__ == '__main__':
    ...
    while opcion != 2:
        if opcion == 1:
            ...
            nodos, aristas, arista_mayor, arista_menor = leer_ejemplar(entrada)

            print("")
            print("Número total de vértices: ", len(nodos))
            print("Número total de aristas: ", len(aristas))
            print("La arista de peso máximo es: [", arista_mayor[0],
                ",", arista_mayor[1], "] con peso:", arista_mayor[2])
            print("La arista de peso mínimo es: [", arista_menor[0],
                ",", arista_menor[1], "] con peso:", arista_menor[2])
            print("---------------------------------------------------------------")
            print("---------------------------------------------------------------")
            print("")
            print("")
